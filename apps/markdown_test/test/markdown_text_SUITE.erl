...
%%% % @generated SignedSource<<439c58c6cc97769e32419758abfbd33b>>
%%%-----------------------------------------------------------------------------
%%% %CopyrightBegin%
%%%
...
-spec test_text_case_1(Config) -> markdown_test:testcase() when
...
-spec test_text_case_2(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
test_text_case_2(_Config) ->
    ?assertMatch(
        {ok, <<"<p>Foo χρῆν</p>"/utf8>>},
        markdown:to_html(<<"Foo χρῆν"/utf8>>),
        "should support unicode text"
    ),
    ok.

-spec test_text_case_3(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
