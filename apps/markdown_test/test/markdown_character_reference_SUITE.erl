...
%%% % @generated SignedSource<<dbc01e3417df21323859df5bfb9d6a7b>>
%%%-----------------------------------------------------------------------------
%%% %CopyrightBegin%
%%%
...
-spec test_character_reference_case_1(Config) -> markdown_test:testcase() when
...
-spec test_character_reference_case_2(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_3(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_4(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_5(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_6(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_7(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_8(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_9(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_10(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_11(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_12(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_13(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_14(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_15(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_16(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_17(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_18(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_19(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_20(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_21(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_22(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_23(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_24(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_25(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_26(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_27(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_28(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_29(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_30(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_character_reference_case_31(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
