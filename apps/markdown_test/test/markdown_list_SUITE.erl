...
%%% % @generated SignedSource<<bf9e4c43260dbb8135e93e0e61684305>>
%%%-----------------------------------------------------------------------------
%%% %CopyrightBegin%
%%%
...
-spec test_list_case_1(Config) -> markdown_test:testcase() when
...
-spec test_list_case_2(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_3(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_4(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_5(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_6(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_7(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_8(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_9(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_10(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_11(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_12(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_13(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_14(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_15(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_16(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_17(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_18(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_19(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_20(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_21(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_22(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_23(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_24(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_25(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_26(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_27(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_28(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_29(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_30(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_31(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_32(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_33(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_34(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_35(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_36(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_37(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_38(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_39(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_40(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_41(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_42(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_43(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_44(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_45(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_46(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_47(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_48(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_49(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_50(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_51(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_52(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_53(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_54(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_55(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_56(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_57(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_58(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_59(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_60(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_61(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_62(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_63(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_64(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_65(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_66(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_67(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_68(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_69(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_70(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_71(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_72(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_73(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_74(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_75(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_76(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_77(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_78(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_79(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_80(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_81(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_82(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_83(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_84(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_85(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_86(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_87(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_88(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_89(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_90(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_91(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_92(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
...
-spec test_list_case_93(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
test_list_case_93(_Config) ->
    ?assertEqual(
        ...
        markdown:to_mdast(<<"* a"/utf8>>, markdown_parse_options:new(#{})),
        "should support lists, list items as `List`, `ListItem`s in mdast"
    ),
    ok.

-spec test_list_case_94(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
test_list_case_94(_Config) ->
    ?assertEqual(
        ...
        markdown:to_mdast(<<"3. a\n4. b"/utf8>>, markdown_parse_options:new(#{})),
        "should support `start` fields on `List` w/ `ordered: true` in mdast"
    ),
    ok.

-spec test_list_case_95(Config) -> markdown_test:testcase() when
    Config :: ct_suite:ct_config().
test_list_case_95(_Config) ->
    ?assertEqual(
        ...
        markdown:to_mdast(<<"* a\n\n  b\n* c"/utf8>>, markdown_parse_options:new(#{})),
