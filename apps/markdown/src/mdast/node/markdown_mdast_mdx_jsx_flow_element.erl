...
%%%-----------------------------------------------------------------------------
%%% % @format
-module(markdown_mdast_mdx_jsx_flow_element).
-moduledoc """
...
%% Types
-type t() :: #markdown_mdast_mdx_jsx_flow_element{}.
...
-spec new() -> MdxJsxFlowElement when
    MdxJsxFlowElement :: t().
new() ->
    #markdown_mdast_mdx_jsx_flow_element{
